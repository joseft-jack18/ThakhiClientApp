...
class ClienteModel (var dniCliente:String, var nombreCliente:String, var apellidoCliente:String,
                    var celularCliente:String, var correoCliente:String, var claveCliente:String,
                    var latitudCliente:Double, var longitudCliente:Double, var fotoCliente:String)
{
    companion object {
